...
### Задача
Необходимо проверить корректность проведения А/В теста
Проанализировать результаты и решить, стоит ли принимать изменения, связанные с внедрением улучшенной рекомендательной системы
### Описание
